    ...
    function Library:Keybind(cfg)
        ...
        Utility:Connect(UserInputService.InputBegan, function(input)
            ...
            if Keybind.Listening then
                Keybind.Set((input.UserInputType == Enum.UserInputType.Keyboard or input.UserInputType == Enum.UserInputType.Gamepad1 or input.UserInputType == Enum.UserInputType.Gamepad2) and input.KeyCode or input.UserInputType)
